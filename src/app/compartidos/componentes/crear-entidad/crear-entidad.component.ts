...
export class CrearEntidadComponent<TDTO, TCreationDTO> implements AfterViewInit{
  ...
  servicioCRUD = inject(SERVICIO_CRUD_TOKEN) as IServicioCRUD<TDTO, TCreationDTO>;
  ...
  guardarCambios(entidad: TCreationDTO){
